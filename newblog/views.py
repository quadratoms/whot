...
def register(request):
	...
	if 'btnreg' in request.POST:
		...
		if User.objects.filter(username=username).exists():
			...
			return redirect('register')
	return render(request, 'register.html', {'r':r})
...
def edit_profile(request):
	...
	return render(request, 'edit_profile.html', {'form':form, 'r':r})
...
def home(request):
    ...
    #gethelp(request)
    return render(request, 'home.html', {'story': story, 'randoms':randoms, 'r':r})
...
def article(request, id):
    ...
    return render(request, 'article.html', {'story': story, 'r':r})
...
def cat(request, id):
    ...
    return render(request, 'article_cat.html', {'story': story, 'storys':storys, 'r':r})
...
def create_or_edit_post (request, id =None ):
	...
	if request.method == "POST" :
		...
		if form. is_valid ():
			...
			form.save()
			post=Article.objects.get(id=post.id)
...
def profile(request, id):
	...
	return render(request, 'profile.html', {'profile':profile, 'userprof':userprof, 'r':r})
